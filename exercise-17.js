...
function totalDigitRekursif(angka) {
  ...
  if(str.length === 1) return Number(str[0])
  var angkaDepan = Number(str[0])
  var sisa = Number(str.slice(1))
  return angkaDepan + totalDigitRekursif(sisa)
  //return totalDigitRekursif(newAngka)
}
